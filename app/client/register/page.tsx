                ...
                <div className="rounded-xl border border-movek-border bg-movek-card p-6 sm:p-8">
                    ...
                    <div className="mb-8 text-center">
                        ...
                        <p className="mt-1 text-sm text-movek-text-secondary">
                            Accédez à l&apos;ensemble du catalogue industriel MOVEK
                        </p>
                    ...
                    <form ref={formRef} action={formAction} className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                                ...
                                <Input name="fonction" placeholder="Votre fonction"
                                    className="mt-1 border-movek-border bg-movek-navy text-white placeholder:text-movek-text-secondary" />
                            </div>
                            <div>
                                <Label className="text-movek-text-secondary">Entreprise *</Label>
                                <Input name="entreprise" required minLength={2} placeholder="Nom de l'entreprise"
                                    className="mt-1 border-movek-border bg-movek-navy text-white placeholder:text-movek-text-secondary" />
                        ...
                        {/* Row 7: Message */}
                        <div>
                            <Label className="text-movek-text-secondary">Message (optionnel)</Label>
                            <Textarea name="message" placeholder="Message pour l'équipe ETREND (optionnel)"
                        ...
                        <div>
                            <label className="flex items-start gap-3 cursor-pointer">
                                ...
                                <span className="text-xs text-movek-text-secondary">
                                    J&apos;accepte les{" "}
                                    <Link href="/legal/cgv" target="_blank" className="text-movek-orange underline">
                                        CGV
                                    </Link>{" "}
                                    et la{" "}
                    ...
                    <p className="mt-6 text-center text-sm text-movek-text-secondary">
                        ...
                        <Link href="/client/login" className="font-semibold text-movek-orange hover:underline">
                            Se connecter
                        </Link>
                    </p>
                </div>
